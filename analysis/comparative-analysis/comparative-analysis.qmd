...
pal <- c("#1b9e77", "#d95f02", "#7570b3", "#4b7b16", "#59901a", "#66a61e", "#73bc22", "#81d126", "#c71670", "#de197d", "#e7298a", "#ea4097", "#ec57a3", "#e6ab02") # color palette for plots
...
ppo_distinct <- agent_data %>% dplyr::select(agent_tag) %>%
  filter(str_detect(agent_tag, "ppo")) %>% distinct()

dreamer_distinct <- agent_data %>% dplyr::select(agent_tag) %>%
  filter(str_detect(agent_tag, "dreamer")) %>% distinct()
  ...
  mutate(agent_type = ifelse(str_detect(agent_tag, "Random Walker"), "Random Walker",
                             ifelse(str_detect(agent_tag, "Random Action"), "Random Action Agent",
                                    ifelse(str_detect(agent_tag, "Vanilla"), "Simple Goal-Directed Agent",
                                           ifelse(agent_type == "child", "Human Child", agent_tag))))) %>%
  group_by(agent_type) %>% 
                                           ...
                                           ifelse(agent_type == "child" & age == 4, "4 Year Old",
                                                  ifelse(agent_type == "child" & age == 5, "5 Year Old",
                                                         ifelse(agent_type == "child" & age == 6, "6 Year Old",
                                                                ifelse(agent_type == "child" & age == 7, "7 Year Old", agent_tag))))))),
         agent_type = haven::as_factor(agent_type)) %>%
  group_by(agent_type, basicTask, opControlTask, cvchickTask, pctb3CupTask, pctbGridTask) %>%
  summarise(`Percentage Instances Passed` = (sum(success)/n())) %>%
  mutate(`Task Type` = ifelse(basicTask == 1, "Basic",
...
Next, we present some simple frequentist statistics, to explore the data before doing the more complex measurement layouts. We run Kruskall-Wallis tests on each type of task, to investigate the magnitude of the difference between the groups. Please excuse the unformatted outputs.

### Basic Tasks

Differences based on success:

```{r KW basic success}

basic_tasks_KW_test <- final_results %>%
  filter((Suite == "Controls" | Suite == "Tutorial") & SubSuite == "Basic") %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
         ...
         agent_type = haven::as_factor(agent_type)) %>%
  group_by(agent_tag_seed, agent_type) %>%
  summarise(proportion_success = sum(success)/n())

basic_kruskal <- kruskal.test(proportion_success ~ agent_type, data = basic_tasks_KW_test)

basic_dunn <- dunnTest(proportion_success ~ agent_type, data = basic_tasks_KW_test,
                method="holm")
...
Differences based on correct choice:

```{r KW basic choice}

basic_tasks_KW_test <- final_results %>%
  filter((Suite == "Controls" | Suite == "Tutorial") & SubSuite == "Basic") %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, correctChoice) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
                                    ifelse(is.na(age) & str_detect(agent_tag, "Random Action"), "Random Action", 
         ...
         agent_type = haven::as_factor(agent_type)) %>%
  group_by(agent_tag_seed, agent_type) %>%
  summarise(proportion_correctChoice = sum(correctChoice)/n())

basic_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = basic_tasks_KW_test)

basic_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = basic_tasks_KW_test,
                method="holm")
...
```{KW CV Control Success}

cvchickcontrol_tasks_KW_test <- final_results %>%
  filter((Suite == "Controls" | Suite == "Tutorial") & Paradigm == "CVChick") %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
cvchickcontrol_kruskal <- kruskal.test(proportion_success ~ agent_type, data = cvchickcontrol_tasks_KW_test)

cvchickcontrol_dunn <- dunnTest(proportion_success ~ agent_type, data = cvchickcontrol_tasks_KW_test,
                method="holm")

print(cvchickcontrol_kruskal)

print(cvchickcontrol_dunn)

```

Differences based on correct choice:

```{KW CV Control Choice}
...
cvchickcontrol_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = cvchickcontrol_tasks_KW_test)

cvchickcontrol_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = cvchickcontrol_tasks_KW_test,
                method="holm")
...
```{r KW PCTB 3 Cup Control Success}

pctb3cupcontrol_tasks_KW_test <- final_results %>%
  filter((Suite == "Controls" | Suite == "Tutorial") & Paradigm == "PCTB" & str_detect(Task, "Cup")) %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
pctb3cupcontrol_kruskal <- kruskal.test(proportion_success ~ agent_type, data = pctb3cupcontrol_tasks_KW_test)

pctb3cupcontrol_dunn <- dunnTest(proportion_success ~ agent_type, data = pctb3cupcontrol_tasks_KW_test,
                method="holm")

print(pctb3cupcontrol_kruskal)

print(pctb3cupcontrol_dunn)

```

Differences based on choice:

```{r KW PCTB 3 Cup Control Choice}
...
pctb3cupcontrol_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = pctb3cupcontrol_tasks_KW_test)

pctb3cupcontrol_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = pctb3cupcontrol_tasks_KW_test,
                method="holm")
...
```{r KW Grid Control Success}

pctbgridcontrol_tasks_KW_test <- final_results %>%
  filter((Suite == "Controls" | Suite == "Tutorial") & Paradigm == "PCTB" & str_detect(Task, "Grid")) %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
pctbgridcontrol_kruskal <- kruskal.test(proportion_success ~ agent_type, data = pctbgridcontrol_tasks_KW_test)

pctbgridcontrol_dunn <- dunnTest(proportion_success ~ agent_type, data = pctbgridcontrol_tasks_KW_test,
                method="holm")

print(pctbgridcontrol_kruskal)

print(pctbgridcontrol_dunn)

```

Differences based on choice:

```{r KW Grid Control Choice}
...
pctbgridcontrol_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = pctbgridcontrol_tasks_KW_test)

pctbgridcontrol_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = pctbgridcontrol_tasks_KW_test,
                method="holm")
...
```{r KW CV Tests Success}

cvchicktest_tasks_KW_test <- final_results %>%
  filter(goalBecomesAllocentricallyOccluded == 1 & Paradigm == "CVChick") %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
cvchicktest_kruskal <- kruskal.test(proportion_success ~ agent_type, data = cvchicktest_tasks_KW_test)

cvchicktest_dunn <- dunnTest(proportion_success ~ agent_type, data = cvchicktest_tasks_KW_test,
                method="holm")

print(cvchicktest_kruskal)

print(cvchicktest_dunn)
...
cvchicktest_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = cvchicktest_tasks_KW_test)

cvchicktest_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = cvchicktest_tasks_KW_test,
                method="holm")
...
```{r KW PCTB 3 Cup Test Success}

pctb3cuptests_tasks_KW_test <- final_results %>%
  filter(goalBecomesAllocentricallyOccluded == 1 & Paradigm == "PCTB" & str_detect(Task, "Cup")) %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
pctb3cuptests_kruskal <- kruskal.test(proportion_success ~ agent_type, data = pctb3cuptests_tasks_KW_test)

pctb3cuptests_dunn <- dunnTest(proportion_success ~ agent_type, data = pctb3cuptests_tasks_KW_test,
                method="holm")

print(pctb3cuptests_kruskal)

print(pctb3cuptests_dunn)

```

Differences based on choice:

```{r KW PCTB 3 Cup Test Choice}
...
pctb3cuptests_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = pctb3cuptests_tasks_KW_test)

pctb3cuptests_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = pctb3cuptests_tasks_KW_test,
                method="holm")
...
```{r KW PCTB Grid Test Success}

pctbgridtests_tasks_KW_test <- final_results %>%
  filter(goalBecomesAllocentricallyOccluded == 1 & Paradigm == "PCTB" & str_detect(Task, "Grid")) %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
pctbgridtests_kruskal <- kruskal.test(proportion_success ~ agent_type, data = pctbgridtests_tasks_KW_test)

pctbgridtests_dunn <- dunnTest(proportion_success ~ agent_type, data = pctbgridtests_tasks_KW_test,
                method="holm")

print(pctbgridtests_kruskal)

print(pctbgridtests_dunn)

```

Differences based on choice:

```{r KW PCTB Grid Test Choice}
...
pctbgridtests_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = pctbgridtests_tasks_KW_test)

pctbgridtests_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = pctbgridtests_tasks_KW_test,
                method="holm")
...
```{r KW Overall Success}

overall_tasks_KW_test <- final_results %>%
  dplyr::select(agent_tag, agent_type, age, aai_seed, success) %>%
  mutate(agent_tag_seed = haven::as_factor(paste0(agent_tag, "_", aai_seed)),
         agent_type = ifelse(is.na(age) & !str_detect(agent_tag, "dreamer|ppo|Random"), agent_type,
                             ifelse(is.na(age) & str_detect(agent_tag, "dreamer|ppo"), agent_tag, 
...
overall_kruskal <- kruskal.test(proportion_success ~ agent_type, data = overall_tasks_KW_test)

overall_dunn <- dunnTest(proportion_success ~ agent_type, data = overall_tasks_KW_test,
                method="holm")

print(overall_kruskal)
...
overall_kruskal <- kruskal.test(proportion_correctChoice ~ agent_type, data = overall_tasks_KW_test)

overall_dunn <- dunnTest(proportion_correctChoice ~ agent_type, data = overall_tasks_KW_test,
                method="holm")
