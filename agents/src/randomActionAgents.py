...
if __name__ == "__main__":
    ...
    singleEpisodeRandomActionAgent = RandomActionAgent(max_step_length=max_step_length,
    ...
    watch_random_action_agent_single_config(configuration_file=configuration_file, agent = singleEpisodeRandomActionAgent)