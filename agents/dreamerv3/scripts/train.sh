...
# A5: OP test continued from A4
xvfb-run -a python train.py \
  --task ../../configs/tests_agents/training_curricula/op_tests_curriculum.yml \
  --env ../../env/env3.1.3/AAI.x86_64 \
  --from-checkpoint ./logdir/A4/training-2023_10_24_12_30-op_controls_33percent_part3/checkpoint.ckpt \
  --dreamer-args "--run.steps 3000000"