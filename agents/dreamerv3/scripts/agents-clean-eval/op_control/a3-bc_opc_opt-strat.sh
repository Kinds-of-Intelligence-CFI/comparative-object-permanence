...
#   --from-checkpoint ./logdir/clean/a3-bc_opc_opt-strat/checkpoint.ckpt \
#   --logdir ./logdir/clean-eval/a3-bc_opc_opt-strat_basic_controls \
...
#   --env ../../env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/clean/a3-bc_opc_opt-strat/checkpoint.ckpt \
#   --logdir ./logdir/clean-eval/a3-bc_opc_opt-strat_op_controls \
...
xvfb-run -a python train.py \
  ...
  --env ../../env/env3.1.3/AAI.x86_64 \
  --from-checkpoint ./logdir/clean/a3-bc_opc_opt-strat/checkpoint.ckpt \
  --logdir ./logdir/clean-eval/a3-bc_opc_opt-strat_op_controlsp2 \
  --start-from 2000 \
...
#   --env ../../env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/clean/a3-bc_opc_opt-strat/checkpoint.ckpt \
#   --logdir ./logdir/clean-eval/a3-bc_opc_opt-strat_op_tests \
