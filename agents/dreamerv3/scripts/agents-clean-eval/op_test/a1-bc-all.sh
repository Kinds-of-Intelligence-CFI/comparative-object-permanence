...
#   --logdir ./logdir/clean-eval/a1-bc-all_basic_controls \
...
#   --env ../../env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/clean/a1-bc-all/checkpoint.ckpt \
#   --logdir ./logdir/clean-eval/a1-bc-all_op_controls \
...
#   --env ../../env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/clean/a1-bc-all/checkpoint.ckpt \
#   --logdir ./logdir/clean-eval/a1-bc-all_op_tests \
...
xvfb-run -a python train.py \
  ...
  --env ../../env/env3.1.3/AAI.x86_64 \
  --from-checkpoint ./logdir/clean/a1-bc-all/checkpoint.ckpt \
  --logdir ./logdir/clean-eval/a1-bc-all_op_testsp2 \
  --start-from 1600 \
  --dreamer-args "--run.steps 0.25e6"